...
Often, you want to upload only to a specific S3 Folder. You can use the `upload_dir` option to set the S3 destination folder. This example uploads to the `travis-builds` folder of your s3 bucket.
