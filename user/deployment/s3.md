...
Optionally cache controls can be set more fine-grained on a per file extension basis. This e.g. allows image files - such a .png, .jpg, or .webp - to be aggresively cached, while .html are not cached at all.
