...
For all repositories on [travis-ci.org](https://travis-ci.org), you can obtain the public key anoymously using the older API at `https://api.travis-ci.org/repos/foo/bar/key`.
...
Repositories (both public and private) on [travis-ci.com](https://travis-ci.com) requires an authorized user's API token to obtain the public key.
...
This method also works with repositories on [travis-ci.org](https://travis-ci.org).
