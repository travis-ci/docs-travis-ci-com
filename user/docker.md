...
> For information on how to use Docker on Travis CI Enterprise check out [https://docs.travis-ci.com/user/enterprise/build-images/#Enabling-Docker-Builds](Enabling Docker Builds)
