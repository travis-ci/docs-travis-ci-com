...
We know that some of our users want MySQL 5.6 desperately, so select images (Ruby, PHP, Python, Node.js)
for this 2015-04-27 updates will be available for those who wish to use it upon request.
Please email us at support@travis-ci.com with the name of the repository you wish to use.
(For this, you will have to use the standard infrastructure.)
