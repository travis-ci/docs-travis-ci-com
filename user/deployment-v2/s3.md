...
{% include deploy/providers/s3.md %}
...
Remember that you need to set the bucket to have an ACL of `public` for anybody
to be able to see your website.
...
## Set upload files starting with a dot
