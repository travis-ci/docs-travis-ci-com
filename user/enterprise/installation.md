...
|:-----|:--------------------------|:----------------|:-----------------------------------------------------------------------------|
| 8800 | Administrators' computers | Custom TCP Rule | Enterprise Admin Dashboard. |
| 5672 | Worker machine(s)         | Custom TCP Rule | RabbitMQ Non-SSL.                                                        |
| 4567 | Worker machine(s)         | Custom TCP Rule | RabbitMQ SSL.                                                            |
