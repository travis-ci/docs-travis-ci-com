...
You may use your admin-console to [upload your self-signed SSL certificate](#) and/or you may need to [disable SSL Verification](#disabling-ssl-in-travis-ci-enteprise-3.x) mechanism. 
...
1. Access the admin-console config page under `https://[platform_host]:3333`. If it's not started, try running `kubectl kots admin-console --namespace [namespace]` 
2. Browse to 'Config'
...
2. Browse to 'Config'
3. Find 'HTTP Setting'
4. Choose from existing methods: auto-generated self-signed key, uploaded certificate, generated [letsencrypt certificate](#using-a-lets-encrypt-ssl-certificate) or disable https and save settings
...
### Renewing your certificate for TCIE 2.x
...
### Automate renewal of your Let's Encrypt SSL Certificate with a cron job (TCIE2.x)
