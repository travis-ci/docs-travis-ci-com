...
The very short guide to using Travis CI. You need to sign up for a [GitHub account](https://github.com/) if you do not already have one. 

This short guide uses a PHP project as an example. If you prefer a different language, check the longer guides for each language: 
