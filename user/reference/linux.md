...
* [Ubuntu Xenial 16.04](/user/reference/xenial/) *deprecated*
* [Ubuntu Trusty 14.04](/user/reference/trusty/) *deprecated*
...
We use Ubuntu Focal 20.04 as default. You will find more about packages, tools and settings in [Ubuntu Focal 20.04](/user/reference/focal/).
