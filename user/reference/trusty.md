...
*WARNING: This feature is deprecated, see annoucement [here](https://blog.travis-ci.com/2018-10-04-combining-linux-infrastructures). Please use the Fully-virtualized via `sudo: required` instead.
