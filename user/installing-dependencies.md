...
To install packages that are not included in the [default OSX environment](/user/osx-ci-environment/#Compilers-%26-Build-toolchain) use [Homebrew](http://brew.sh) in your `.travis.yml`. For example, to install beanstalk:
