...
Currently, you'll find the **following versions installed: 9.1.14, 9.2.9, 9.3.5 and 9.4.0**, respectively.
...
This selects PostgreSQL 9.4 as the version your build expects to be running.
