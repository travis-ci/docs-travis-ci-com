...
This guide covers build environment and configuration topics specific to PHP projects. Please make sure to read our [general build configuration guide](/docs/user/build-configuration/) first.
